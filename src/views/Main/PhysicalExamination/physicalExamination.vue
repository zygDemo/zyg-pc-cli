  ...
  <div>
    ...
    <el-table :data="tableList" style="width: 100%" border>
      ...
      <el-table-column
        ...
        align="center"
      />
      <el-table-column prop="diseasesHistory" label="心肺状况" align="center" />
      <el-table-column prop="allergicHistory" label="胸透状况" align="center" />
      <el-table-column prop="time" label="体检日期" align="center" />
    ...
    <el-dialog v-model="dialogVisible" @close="dialogVisible = false">
      ...
      >
        ...
        <el-form-item label="体检日期" prop="time">
...
const formRules = reactive({
  ...
  time: [{ required: true, message: "请输入体检日期", trigger: "blur" }],
});
onMounted(() => {
  initData();
});
...
const initData = () => {
  tableList.value = tableStore.physicalExaminationList;
};
const search = ref("");
const handleSearch = () => {
